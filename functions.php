...
function wordpress_starter_theme_setup() {
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'wordpress_starter_theme_custom_background_args',
			array(
...
function wordpress_starter_theme_scripts() {
	wp_enqueue_style( 'wordpress-starter-theme-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'wordpress-starter-theme-style', 'rtl', 'replace' );

	wp_enqueue_script( 'wordpress-starter-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
